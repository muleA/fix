...
@Controller('searchHistorys')
@ApiTags('searchHistorys')
 ...
 */
@Get('get-searchHistory')
@ApiResponseType(SearchHistoryPresenter, false)
async getSearchHistory(@Query() id: string) {
