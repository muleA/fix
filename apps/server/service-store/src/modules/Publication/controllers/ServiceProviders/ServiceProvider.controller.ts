 ...
 */
@Get('get-serviceProvider')
@ApiResponseType(ServiceProviderPresenter, false)
async getServiceProvider(@Query() id: string) {
 ...
 * See the [definition of the ServiceProviderPresenter file]{@link ServiceProviderPresenter} to see a list of required properties
 */
@Get('get-serviceProviders')
@ApiResponseType(ServiceProviderPresenter, true)
async getServiceProviders() {
const serviceProviders = await this.useCase.fetServiceProviders();
return serviceProviders.map((serviceProvider) => new ServiceProviderPresenter(serviceProvider));
}
 ...
 */ 
 @Put('update-serviceProvider')
@ApiResponseType(ServiceProviderPresenter, true)
async updateServiceProvider(@Body() updateServiceProviderDto: UpdateServiceProviderDto) {
...
@Post('add-DelegatedService')
@ApiResponseType(DelegatedServicePresenter, true)
async addDelegatedService(@Body() createDelegatedServiceDto: CreateDelegatedServiceDto) {
const delegatedServiceCreated = await this.useCase.addDelegatedService( createDelegatedServiceDto);
return new ServiceProviderPresenter(delegatedServiceCreated );
}
/**
...
*/ 
@Put('edit-DelegatedService')
@ApiResponseType(DelegatedServicePresenter, true)
async editDelegatedService(@Body() createDelegatedServiceDto: UpdateDelegatedServiceDto) {
...
*/
@Delete('remove-DelegatedService')
@ApiResponseType(DelegatedServicePresenter, true)
...
*/ 
@Put('update-DelegatedServices')
@ApiResponseType(DelegatedServicePresenter, true)
async updateDelegatedService(@Body() createDelegatedServiceDto: CreateDelegatedServiceDto[]) {
