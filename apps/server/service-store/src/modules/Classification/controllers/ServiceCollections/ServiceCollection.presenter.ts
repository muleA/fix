...
this.serviceEntries = serviceCollection.serviceEntries.map(item=>new ServiceEntryPresenter(item));  
...
this.resources = serviceCollection.resources.map(item=>new ServiceResourcePresenter(item));  
