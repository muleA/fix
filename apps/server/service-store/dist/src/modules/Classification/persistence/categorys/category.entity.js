...
let CategoryEntity = CategoryEntity_1 = class CategoryEntity extends CommonEntity_1.CommonEntity {
};
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => CategoryEntity_1, parent => parent.parent),
