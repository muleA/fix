...
import SupportedLangugaeSideTable from '../components/supported-languages-side-table';
import LanguageForm from '../components/languages-form';
const NewServiceSupportedLanguage = () => {
  return (
    <div className="tw-w-full tw-min-h-screen tw-p-4">
      <div className="tw-flex tw-items-start">
        <AdminstrationSideBar />
        <SupportedLangugaeSideTable />
...
export default NewServiceSupportedLanguage;
