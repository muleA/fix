        ...
        <div className="tw-w-full tw-min-h-screen tw-p-4">
            ...
            <Card shadow="sm" padding="lg">
                ...
                <Card.Section className='tw-flex tw-p-4 tw-justify-end'>
                    <Input className="tw-w-1/3 tw-mr-2" size='xs' placeholder="search service"
                    ...
                    >
                        <div>
                            <div className='tw-pl-4 tw-py-2 tw-font-bold tw-border-b'>Filter By Category</div>
                            <div className='tw-px-4'>
                                <Checkbox size="xs" className='tw-my-4' label="Educational" />
                                <Checkbox size="xs" className='tw-my-4' label="Health related " />
                                <Divider my="xs" label="Filter By tags" labelPosition="center" />
