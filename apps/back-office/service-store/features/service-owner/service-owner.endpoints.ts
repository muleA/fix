const ServiceOwnersEndPoint = {
  getServiceOwner: `${process.env.NEXT_PUBLIC_BACKEND_BASEURL}api/service-owners/get-service-owner/`,
  ...
  deleteServiceOwner: `${process.env.NEXT_PUBLIC_BACKEND_BASEURL}api/service-owners/delete-service-owner/`,
};
