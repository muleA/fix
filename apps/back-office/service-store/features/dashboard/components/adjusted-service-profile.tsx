...
const AdjustedServiceProfile = () => {
    ...
    return (
      <>
       <DashboardStatCard data={data} Icon={IconAdjustments} count={14} 
       countHeading={'Services'} 
       headingLink={'/service-store/service/public-service'} 
       subHeading={'Adjusted Service Profile'} tableHeading={'Name Of Adjusted Service Profile'} 
       tableLink={`/service-store/service/detail/${data[1]}`} />
      </>
    )
}

export default AdjustedServiceProfile;