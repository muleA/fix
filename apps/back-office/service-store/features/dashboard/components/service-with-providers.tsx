...
const TotalServicesWithProviders = () => {
    ...
    return (
      <>
       ...
       subHeading={'Services With Providers'} tableHeading={'Name Of Service With Providers'} 
       tableLink={`/service-store/service/detail/${data[1]}`} />
      </>
    )
}

export default TotalServicesWithProviders;