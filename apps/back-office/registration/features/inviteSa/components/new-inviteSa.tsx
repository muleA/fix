    ...
    return (
        <div className="tw-flex tw-items-start">
            ...
            <div className={`tw-grow tw-pl-4`}>
                <OptionHeader title={"Super Administrator"} closeLink="/registration/inviteSa" />
                ...
                <div className="tw-flex tw-items-start tw-mt-4">
                    ...
                    >
                        <Accordion.Item label={<AccordionLabel title='New Super Administrator' subTitle='Register new super-administrator' />}>
                            <InviteSaDetailForm mode='new'/>
                        </Accordion.Item>
                    </Accordion>
