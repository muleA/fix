    ...
    return (
        <div className="tw-flex tw-items-start">
            ...
            <div className={`tw-grow tw-pl-4`}>
                <OptionHeader title={"Organization Section"} closeLink="/registration/organization-section" />
                ...
                <div className="tw-flex tw-items-start tw-mt-4">
                    ...
                    >
                        <Accordion.Item label={<AccordionLabel title='New Organization section' subTitle='Register new super-administrator' />}>
                            <OrganizationSectionDetailForm mode='new'/>
                        </Accordion.Item>
                    </Accordion>
...
export default NewOrganizationSection;