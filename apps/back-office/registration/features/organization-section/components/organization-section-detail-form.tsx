...
type OrganizationSectionDetailFormProps = {
    mode: "new" | "update";
};

const OrganizationSectionDetailForm = (props: OrganizationSectionDetailFormProps) => {
    const { register, handleSubmit, formState: { errors }, setValue } = useForm({ resolver: yupResolver(schema) });

    if (props.mode == 'update') {
        setValue("amhName", "ራንደም ስም");
        setValue("enName", "Random name");
        setValue("amhDescription", "ራንደም ራንደም ራንደም ራንደም ");
        setValue("enDescription", "Random description");
    }
...
export default OrganizationSectionDetailForm;