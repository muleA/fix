...
import ArchiveOrganizationDetailForm from './archive-organization-detail-form';
import ArchiveSideTable from './archive-side-table';
    ...
    return (
        <div className="tw-flex tw-items-start">
            ...
            <div className={`tw-grow tw-pl-4`}>
                <OptionHeader title={id.toString()} closeLink="/registration/archive" />
