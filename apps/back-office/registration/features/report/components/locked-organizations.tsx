...
const LockedOrganizations = () => {
    ...
    const organizations = [
        ...
        { shortName: "MOBB", description: "blah basdflah", organizationType: "Government" },
        { shortName: "AXXX", description: "blah bsadfdsflah", organizationType: "Agency" },
        { shortName: "GVVVV", description: "blahasddfsdaffsd blah", organizationType: "NGO" },
    ];
            ...
            <Card shadow="sm" padding="lg">
                ...
                <Card.Section className='tw-flex tw-p-4 tw-items-center tw-justify-between'>
                    <Menu
                        ...
                        <Menu.Item
                            onClick={() => exportDataToExcel(organizations, "locked-organizations-report")}
                        >
                            Export excel
                        </Menu.Item>
                        <Menu.Item
...
export default LockedOrganizations;