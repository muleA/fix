...
const DeactiveOrganizations = () => {
    const [printModalOpened, setPrintModalOpened] = useState(false)
    const [filterOpened, setFilterOpened] = useState(false);
    const [perPage, setPerPage] = useState<string>("10");
    const organizations = [
        { shortName: "FFFFsa", description: "blah blah", organizationType: "Ministry" },
        { shortName: "MCCCasHE", description: "blah basdflah", organizationType: "Government" },
        { shortName: "Asd2efesadfsadD", description: "blah bsadfdsflah", organizationType: "Agency" },
        { shortName: "WWWd", description: "blahasddfsdaffsd blah", organizationType: "NGO" },
    ];
            ...
            <Card shadow="sm" padding="lg">
                ...
                <Card.Section className='tw-flex tw-p-4 tw-items-center tw-justify-between'>
                    <Menu
                        ...
                        <Menu.Item
                            onClick={() => exportDataToExcel(organizations, "deactive-organizations-report")}
                        >
                            Export excel
                        </Menu.Item>
                        <Menu.Item
...
export default DeactiveOrganizations;