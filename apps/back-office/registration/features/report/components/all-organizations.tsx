...
const AllOrganizations = () => {
    ...
    const organizations = [
        { shortName: "AAU", description: "blah blah", organizationType: "Ministry" },
        { shortName: "MOSHE", description: "blah basdflah", organizationType: "Government" },
        { shortName: "ABCD", description: "blah bsadfdsflah", organizationType: "Agency" },
        { shortName: "GNGO", description: "blahasdfsd blah", organizationType: "NGO" },
    ];
            ...
            <Card shadow="sm" padding="lg">
                ...
                <Card.Section className='tw-flex tw-p-4 tw-items-center tw-justify-between'>
                    <Menu
                        ...
                        <Menu.Item
                            onClick={() => exportDataToExcel(organizations, "all-organizations-report")}
                        >
                            Export excel
                        </Menu.Item>
                        <Menu.Item
