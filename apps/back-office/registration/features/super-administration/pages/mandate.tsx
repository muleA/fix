    ...
    return (
        <div className="tw-w-full tw-min-h-screen tw-p-4">
            <div className="tw-flex tw-items-start">
                ...
                <Card className='tw-w-9/12 tw-ml-4' shadow="sm" padding="lg">
                                    ...
                                    mandates.map((item) => (
                                        <tr key={item.name} className="visibility-hoverable-container">
                                            ...
                                            <td className='hoverable-visibility-content'>
                                                <Link href={`/registration/mandate/detail/${item.name}`}><a className="tw-block tw-bg-gray-50 hover:tw-outline hover:tw-outline-1 hover:tw-outline-[#1d2861] tw-p-1 tw-rounded"><IconChevronRight color={'#1d2861'} /></a></Link>
                                            </td>
                                        </tr>
                                    ))
                                }
